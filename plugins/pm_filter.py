...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, SINGLE_BUTTON, PROTECT_CONTENT, \
    SPELL_CHECK_REPLY, IMDB_TEMPLATE, IMDB_DELET_TIME, NO_RESULTS_MSG, START_MESSAGE, PMFILTER, G_FILTER, BUTTON_LOCK, BUTTON_LOCK_TEXT, NOR_IMG
...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Your message has been sent to my moderators !</b>",
                             reply_markup=InlineKeyboardMarkup(
                                 [[
                                     InlineKeyboardButton("📍 Mᴏᴠɪᴇ ɪs ʜᴇʀᴇ 📍", url="https://t.me/cinema_flix_updates")
                                 ]]
                             )
                             )
...
async def advantage_spell_chok(msg):
    ...
    try:
        ...
        await k.delete()
        return
    movielist = for mov in gs_parsed:

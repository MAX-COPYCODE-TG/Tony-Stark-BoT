...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b><u>🚀𝐅𝐢𝐥𝐞 𝐍𝐚𝐦𝐞 </u></b>: <b><code>{file_name}</code></b><b>\n╭──── • ❰[𝐌𝐨𝐯𝐢𝐞 𝐆𝐫𝐨𝐮𝐩](https://t.me/Mallu_Movie_Hub_Group)❱ • ───➤\n┣ ▫️[𝐎𝐭𝐭 𝐂𝐡𝐚𝐧𝐧𝐞𝐥](https://t.me/cinema_flix_updates)| [𝐋𝐢𝐧𝐤 𝐂𝐡𝐚𝐧𝐧𝐞𝐥](https://t.me/+1pECeV-4ONFiZTE1)\n╰──────── • ◆ • ───────➤\n     ♡ ㅤ   ❍ㅤ     ⎙      ⌲\nˡᶦᵏᵉ  ᶜᵒᵐᵐᵉⁿᵗ   ˢᵃᵛᵉ   ˢʰᵃʳᵉ</b>")

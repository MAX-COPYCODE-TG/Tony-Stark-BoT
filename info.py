...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>✏️ғɪʟᴇ ɴᴀᴍᴇ</b> : <b><code>{file_name}</code></b>\n╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╗\n♻️ 𝙅𝙊𝙄𝙉 :[ᴊᴏɪɴ ɢʀᴏᴜᴘ - 1](https://t.me/Mallu_Movie_Hub_Group)\n♻️ 𝙅𝙊𝙄𝙉 :[ᴊᴏɪɴ ɢʀᴏᴜᴘ - 2](https://t.me/+-U__M8vJ-sU0MTg1)\n♻️ 𝙅𝙊𝙄𝙉 :[ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ](https://t.me/CiNEMA_CiTY_UPDATES)\n♻️ 𝙅𝙊𝙄𝙉 :[ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ](https://t.me/+ZiDeeN9yubk5NDhl)\n♻️ 𝙅𝙊𝙄𝙉 :[sᴇʀɪᴇs ᴄʜᴀɴɴᴇʟ](https://t.me/+HgxnAJ_LajRiNGU1)\n╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╝\n<b>👆ഗ്രൂപ്പിൽ join ചെയ്തതിനു  ശേഷം  File download ചെയുക 🚨</b><b>⚙️ғɪʟᴇ sɪᴢᴇ</b> : <b><i>{file_size}</i></b>")
